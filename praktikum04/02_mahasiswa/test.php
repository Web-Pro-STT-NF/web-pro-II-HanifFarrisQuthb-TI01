...
<body>
    ...
    <div class="row pt-2">
        ...
        <div class="col-12">
            ...
            if (!empty($proses)) {
                $mahasiswa1 = new NilaiMahasiswa($_nama, $_nim, $_pilih_mk, $_nilai);

                $mahasiswa1->print();
                echo '<br>Nilai segitu berati Grade anda Adalah ' . $mahasiswa1->grade();
                echo '<br>Grade nya ' . $mahasiswa1->grade() . ' berati ' . $mahasiswa1->status();
